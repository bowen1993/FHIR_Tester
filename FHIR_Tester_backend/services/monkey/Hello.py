...
steps.append(('Genomic Auth','/_2.png'))

ele.click()
ele = driver.find_element_by_xpath('/html/body/div/div/div/form/button[1]')
ele.click()
driver.get_screenshot_as_file('/_3.png')
steps.append(('DoGenomicAuth','/_3.png'))
ele = driver.find_element_by_xpath("/html/body/div/table/tbody/tr[2]/td[2]/a")
ele.click()
driver.get_screenshot_as_file('/_4.png')
steps.append(('Click','/_4.png'))
driver.close()