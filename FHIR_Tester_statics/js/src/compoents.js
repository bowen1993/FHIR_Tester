        ...
        render:function(){
            return (
            	<div className="input-group">
                    ...
                    <input className="form-control awesomplete" onChange={this.handleChange} onBlur={this.getServer} onKeyUp={this.handleKey} id="serverlist" placeholder={'server name'}/>
                </div>
