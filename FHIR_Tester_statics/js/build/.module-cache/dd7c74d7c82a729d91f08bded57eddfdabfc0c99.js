        ...
        render:function(){
            return (
                React.createElement("div", {class: "dropdown"}, 
                    React.createElement("button", {class: "btn btn-default dropdown-toggle", type: "button", id: "dropdownMenu1", "data-toggle": "dropdown"}, 
                        "Dropdown", 
                        React.createElement("span", {class: "caret"})
                    ), 
                    React.createElement("ul", {class: "dropdown-menu", role: "menu", "aria-labelledby": "dropdownMenu1"}, 
