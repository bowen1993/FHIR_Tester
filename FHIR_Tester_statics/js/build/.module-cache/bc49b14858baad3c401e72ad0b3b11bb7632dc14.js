...
(function(){
    ...
    var ServerList = app.ServerList = React.createClass({displayName: "ServerList",
        ...
        onServerClick:function(event){
            this.setState({currentDisplay:event.currentTarget.serverName});
        },
        render:function(){
            return (
                React.createElement("div", {className: "dropdown"}, 
                    ...
                    React.createElement("ul", {className: "dropdown-menu", role: "menu", "aria-labelledby": "dropdownMenu1"}, 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": "SMART", onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "SMART")), 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": "HAPI FHIR", onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "HAPI FHIR")), 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": "FHIR Genomics", onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "FHIR Genomics"))
                    )
                )
            );
        }
