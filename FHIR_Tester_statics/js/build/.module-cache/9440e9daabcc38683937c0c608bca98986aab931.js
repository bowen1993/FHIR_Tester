...
(function() {
    ...
    var TesterApp = React.createClass({displayName: "TesterApp",
        ...
        toggleEditting:function(){
            this.setState({isEditting:!this.isEditting});
        },
        render:function(){
            return (
                    ...
                    React.createElement("div", {className: "test-input"}, 
                        ...
                        React.createElement("div", {className: "btnArea"}, 
                            React.createElement("label", null, 
                                React.createElement("input", {type: "checkbox", checked: this.state.isEditting}), " Code Eidtor"
                            ), 
                            React.createElement("label", null, 
                                React.createElement("input", {type: "checkbox", checked: this.state.isCustomedURL}), " Customed URL"
                            )
                        ), 
