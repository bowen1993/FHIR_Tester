        ...
        render:function(){
            return (
                React.createElement("div", {className: "index-content"}, 
                    ...
                    this.state.isRegister ? React.createElement(RegisterWindow, null) : React.createElement(LoginWindow, {login_action: this.handleLogin, updateUsername: this.updateUsername, updatePassword: this.updatePassword}), 
