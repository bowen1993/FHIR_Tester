            ...
            return (
                React.createElement("div", {className: "dropdown"}, 
                    ...
                    this.state.servers.map(function(server){
                        return React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": server.name, "data-serverid": server.id, onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "SMART"))
                    }), 
                        
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": "HAPI FHIR", "data-serverid": "2", onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "HAPI FHIR")), 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {"data-serverName": "FHIR Genomics", "data-serverid": "3", onClick: this.onServerClick, role: "menuitem", tabindex: "-1", href: "#"}, "FHIR Genomics"))
                    )
                )
            );
        }
