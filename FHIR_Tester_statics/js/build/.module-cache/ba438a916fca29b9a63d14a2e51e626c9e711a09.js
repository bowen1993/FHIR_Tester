...
(function() {
    ...
    var TesterApp = React.createClass({displayName: "TesterApp",
        getInitialState: function() {
            return {code:"",url:"", isResultReady:true, isLoading:false, isTestPass:true, isTestFail:false, access_token:null, is_history_show:false, isEditting:false, isCustomedURL:false};
        },
