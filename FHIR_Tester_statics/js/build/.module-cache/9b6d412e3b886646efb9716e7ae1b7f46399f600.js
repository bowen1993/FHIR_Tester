        ...
        render:function(){
            return (
                React.createElement("div", {className: "step-brief step-brief-failed", onClick: this.handleTextClick}, 
                    ...
                    this.state.is_modal_show ? React.createElement(Modal, {handleHideModal: this.handleHideModal, title: "Step Image", content: React.createElement(FullImageArea, null)}) : null
                )
            );
        }
    });
                    ...
                    React.createElement("div", {className: "modal-dialog"}, 
                        React.createElement("div", {className: "modal-content"}, 
                            ...
                            React.createElement("div", {className: "modal-body"}, 
                                React.createElement("img", {className: "img-responsive img-rounded full-img", src: "../img/1.png"})
                            ), 
