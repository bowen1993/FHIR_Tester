...
(function(){
            ...
            return (
                React.createElement("div", {className: "result-container bg-success"}, 
                    ...
                    React.createElement("div", {className: "detail-result"}, 
                        React.createElement(StepDisplay, {is_img_show: this.state.is_img_hide})
                    )
                )
            )
        }
    ...
    var StepDisplay = app.StepDisplay = React.createClass({displayName: "StepDisplay",
        getInitialState: function(){
            return {
                is_img_hide:this.props.is_img_hide
            }
        },
        render:function(){
            return (
                React.createElement("div", {className: "step-brief"}, 
                    ...
                    React.createElement("img", {hidden: this.state.is_img_hide, className: "img-responsive step-img", src: "../img/7.png"})
                )
            );
        }
    });
