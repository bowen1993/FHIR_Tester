        ...
        render:function(){
            return (
                React.createElement("div", {className: "user-op"}, 
                    React.createElement("button", {className: "btn-user"}, "History"), 
                    React.createElement("button", {className: "btn-user"}, "Search Task"), 
                    React.createElement("button", {className: "btn-user"}, "Change Password"), 
                    React.createElement("button", {className: "btn-user"}, React.createElement("span", {className: "glyphicon glyphicon-off"}))
                )
            );
        }
    });
