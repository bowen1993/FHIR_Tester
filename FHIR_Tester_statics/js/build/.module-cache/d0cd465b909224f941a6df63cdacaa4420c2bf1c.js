        ...
        render:function(){
            return (
                React.createElement("div", {className: "box"}, 
                    ...
                    this.state.isSearchShow ? React.createElement(Modal, {handleHideModal: this.handleHideModal, title: "History", content: React.createElement(HistoryViewer, null)}) : null
                )
            );
        }
    });
