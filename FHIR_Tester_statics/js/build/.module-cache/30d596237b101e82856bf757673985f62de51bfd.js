...
(function(){
    ...
    var Username_field = account_app.Username_field = React.createClass({displayName: "Username_field",
        ...
        render:function(){
            return (React.createElement("input", {className: "input-base input-username col-lg-8 col-md-8 col-sm-12 col-xs-12", ref: "username", placeholder: "Input Username", onChange: this.handleChange}));
        }
    });
