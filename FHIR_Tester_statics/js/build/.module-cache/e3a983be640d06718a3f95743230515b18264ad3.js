            ...
            return (
                React.createElement("div", {className: "dropdown"}, 
                    ...
                    React.createElement("ul", {className: "dropdown-menu", role: "menu", "aria-labelledby": "dropdownMenu1"}, 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {onClick: this.handle, role: "menuitem", tabindex: "-1", href: "#"}, "SMART")), 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {role: "menuitem", tabindex: "-1", href: "#"}, "HAPI FHIR")), 
                        React.createElement("li", {role: "presentation"}, React.createElement("a", {role: "menuitem", tabindex: "-1", href: "#"}, "FHIR Genomics"))
                    )
                )
            );
        }
