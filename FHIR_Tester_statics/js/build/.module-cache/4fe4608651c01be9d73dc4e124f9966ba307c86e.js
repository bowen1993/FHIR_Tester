...
(function(){
    ...
    var StepDisplay = app.StepDisplay = React.createClass({displayName: "StepDisplay",
        ...
        updateDetail:function(desc){
            this.setState({detail_desc:desc});
        },
        render:function(){
            return (
                React.createElement("div", {className: "step-brief step-brief-success", onClick: this.handleTextClick}, 
                    ...
                    React.createElement("div", {className: "step-detail-area"}, 
                        ...
                        this.props.stepInfo.details.map(function(detail){
                            return React.createElement(StepDetail, {updateDetailContent: this.updateDetail, status: detail.status, desc: detail.desc})
                        })
                        ), 
    ...
    var StepDetail = app.StepDetail = React.createClass({displayName: "StepDetail",
        ...
        onBtnClick:function(){
            this.props.updateDetailContent(this.props.desc);
        },
        render:function(){
            return (
                React.createElement("button", {className: this.props.status ? 'btn btn-circle btn-success': 'btn btn-circle btn-danger'},  this.props.status ? 'P' : 'F')
            )
        }
    })
        ...
        render:function(){
            return (
                React.createElement("div", {className: "task-search-area"}, 
                    React.createElement("input", {className: "input-url", placeholder: "Search Tasks...", refs: "keywordField", onChange: this.onUserInput}), 
                    React.createElement("button", {className: "btn btn-success"}, React.createElement("span", {className: "glyphicon glyphicon-search"})), 
