...
(function(){
    ...
    var Username_field = account_app.Username_field = React.createClass({displayName: "Username_field",
        ...
        render:function(){
            return (React.createElement("input", {className: this.loadClassname, ref: "username", placeholder: "Input Username", onChange: this.handleChange}));
        }
    });
            ...
            return (
                React.createElement("div", {className: "login-area"}, 
                    React.createElement("div", {className: "login-item row"}, 
                        ...
                        React.createElement(Username_field, {classes: "col-lg-8 col-md-8 col-sm-12 col-xs-12"})
                    ), 
                    React.createElement("div", {className: "login-item row"}, 
