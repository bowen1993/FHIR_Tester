...
(function(){
    ...
    var StepDetail = app.StepDetail = React.createClass({displayName: "StepDetail",
        classes:function(){
            return 'btn-round ' + this.props.status ? ' btn-success': ' btn-danger';
        },
        onBtnClick:function(){
        ...
        render:function(){
            return (
                React.createElement("button", {className: this.classes},  this.props.status ? 'P' : 'F')
            )
        }
    })
        ...
        render:function(){
            return (
                React.createElement("div", {className: "user-op"}, 
                    ...
                    React.createElement("button", {className: "btn btn-user btn-circle", onClick: this.handleLogout}, React.createElement("span", {className: "glyphicon glyphicon-off"}))
                )
            );
        }
    });
