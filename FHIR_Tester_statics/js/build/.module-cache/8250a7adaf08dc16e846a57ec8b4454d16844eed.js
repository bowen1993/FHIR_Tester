        ...
        render: function(){
            return (
                React.createElement("div", {className: "result-container bg-success"}, 
                    React.createElement("div", {className: "result-title"}, React.createElement("span", {className: "area-title area-title-black"}, "Test Type: "), " ", React.createElement("span", null, this.props.testType)), 
        ...
        render:function(){
            return (
                React.createElement("div", {className: "step-brief"}, 
                    React.createElement("span", {onClick: this.handleTextClick, className: "step-brief-text"}, "This is a step info"), 
                    React.createElement("div", {hidden: this.state.is_img_hide, className: "step-img-block"}, 
                        React.createElement("img", {className: "img-responsive step-img", src: "../img/7.png"})
                    )
                )
            );
        }
