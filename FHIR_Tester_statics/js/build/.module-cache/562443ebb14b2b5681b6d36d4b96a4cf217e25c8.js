...
(function() {
    ...
    var TesterApp = React.createClass({displayName: "TesterApp",
        ...
        handleTaskSubmit:function(submitType){
            ...
            if (submitType == 2){
                $.ajax({
                    url:'localhost:8000/home/submit',
                    type:'POST',
                    data:{code:this.state.code,language:'python',type:submitType,url:""},
                    dataType:'json',
                    cache:false,
                ...
                React.createElement("div", {className: "box"}, 
                    React.createElement("div", {className: "test-input"}, 
                        React.createElement("div", {className: "btnArea"}, 
                            ...
                            React.createElement(TestButton, {btn_name: "Server Test", submitTestTask: this.handleTaskSubmit, btnType: app.STANDARD_TEST}), 
                            React.createElement(TestButton, {btn_name: "Standard Test", submitTestTask: this.handleTaskSubmit, btnType: app.SERVER_TEST})
                        ), 
