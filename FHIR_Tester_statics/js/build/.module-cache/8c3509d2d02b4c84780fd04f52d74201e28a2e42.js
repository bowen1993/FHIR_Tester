...
(function(){
    ...
    var ServerList = app.ServerList = React.createClass({displayName: "ServerList",
        ...
        onServerClick:function(event){
            console.log(this.refs.menu_display.value)
            this.setState({currentDisplay:this.refs.menu_display.value});
        },
        render:function(){
            return (
                React.createElement("div", {className: "dropdown"}, 
                    React.createElement("button", {ref: "menu_display", dangerouslySetInnerHTML: this.state.currentDisplay, className: "btn btn-default dropdown-toggle", type: "button", id: "dropdownMenu1", "data-toggle": "dropdown"}, 
                        "Servers", 
