...
(function(){
                ...
                React.createElement("div", {className: "step-brief step-brief-success", onClick: this.handleTextClick}, 
                    ...
                    React.createElement("div", {className: "step-detail-area"}, 
                        ...
                        this.props.stepInfo.details.map(function(detail){
                            return React.createElement(StepDetail, {showDetail: this.showDetail, status: detail.status, desc: detail.desc})
                        })
                        ), 
    ...
    var StepDetail = app.StepDetail = React.createClass({displayName: "StepDetail",
        ...
        render:function(){
            return (
                React.createElement("button", {onClick: this.props.showDetail(this.props.desc), className: this.props.status ? 'btn btn-circle btn-success': 'btn btn-circle btn-danger'},  this.props.status ? 'P' : 'F')
            )
        }
    })
